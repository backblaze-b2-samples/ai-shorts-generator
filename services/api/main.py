...
from app.runtime import clips, files, health, jobs, metrics, upload  # noqa: E402
...
app = FastAPI(
    ...
    description=(
        "Turn long videos into AI-picked vertical shorts with burned-in "
        "captions, backed by Backblaze B2"
    ),
    version="0.1.0",
    lifespan=lifespan,
)
