...
import { LayoutDashboard, Upload, FolderOpen, Clapperboard, Settings, Sparkles } from "lucide-react";
import {
  Sidebar,
  SidebarContent,
  SidebarGroup,
...
const navItems = [
  ...
  { title: "Clips", href: "/clips", icon: Clapperboard },
  ...
  return (
    <Sidebar>
      ...
      <SidebarFooter className="border-t border-sidebar-border px-4 py-3">
        <a
          href="https://www.backblaze.com/cloud-storage?utm_source=github&utm_medium=referral&utm_campaign=ai_artifacts&utm_content=b2ai-ai-shorts-generator"
          target="_blank"
